...
<div class="container mt-3">
	<form class="form-horizontal customerForm toggle-disabled" id="addEmployeeForm" method="post" action='<spring:url value="/createEmployee"></spring:url>'>
				...
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-2">
				                 <input type="text" class="form-control" id="inputID" name="staffCode">
				                </div>
				            </div>
				            <div class="form-group row">
				                <label for="inputEmployeeName" class="col-sm-2 col-form-label">Employee Name</label>
				                <div class="col-sm-6">
				                 <input type="text" class="form-control" id="inputEmployeeName" name="staffName">
				                </div>
				            </div>
				            <div class="form-group row">
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-10">
				                  <select name="staffRank">
				                    <option value="10.2">Dummy Value</option>
				                  </select>
				                </div>
				            </div>
				            <div class="form-group row">
					...
					<div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
						 <div class="mt-3">
				            ...
				            <div class="form-group row">
				                ...
				                <div class="col-sm-4">
				                 <input type="date" class="form-control" id="inputLeftDate" name="retirementDate" form="addEmployeeForm">
				                </div>
				                <div class="col-sm-2">
				            ...
				            <div class="col-sm-4">
				                  <div class="mt-3">
				                    <div class="row">
				                        ...
				                        <div class="col">
				                         <input type="text" class="form-control" id="inputBankAccountNumber" name="bankAccount">
				                        </div>
				                    </div>
				                    <div class="row">
				                        <div class="col">
				                    ...
				                    <div class="row">
				                        ...
				                        <div class="col">
				                         <input type="text" class="form-control" id="inputPFAccountNumber" name="pFac">
				                        </div>
				                    </div>
				                    <div class="row mt-5">
				                        <div class="col">
				                    ...
				                    <div class="row">
				                        ...
				                        <div class="col">
				                         <input type="number" step="any" class="form-control" id="inputLessInsurance" name="lifeInsurance">
				                        </div>
				                        <div class="col">
		            ...
		            <div class="col-sm-3 mt-3">
		              <div class="form-group row">
		                  ...
		                  <div class="form-group col">
		                   <input type="number"  step="any" class="form-control" id="inputBasicSalary" name="basicSalary">
		                  </div>
		              </div>
		              <div class="form-group row">
		                  <div class="col">
		                  ...
		                  <div class="form-group col">
		                   <input type="number" step="any" class="form-control" id="inputPFAmount" name="pfDeductionAmount">
		                  </div>
		              </div>
		              <div class="form-group row">
		                  <div class="col">
		              ...
		              <div class="form-group row">
		                  ...
		                  <div class="form-group col">
		                    <input type="number" step="any" class="form-control" id="inputHardshipAllowance" name="programAllowance">
		                  </div>
		              </div>
		            </div>
